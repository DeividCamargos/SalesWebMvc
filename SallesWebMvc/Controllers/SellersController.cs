...
namespace SallesWebMvc.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            {
                return RedirectToAction(nameof(Error), new { message = "Cant't delete seller because he/she has sales" });
            }
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            SellerFormViewModel viewModel = new SellerFormViewModel { Departments = List, Seller = obj };
